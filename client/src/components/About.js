...
const About = props =>{
  return(
    <div>
      ...
      <p>
        <ul>
        <li>Card values rank from 3 to 2, with Aces and Deuces being high. </li>
      ...
      <ul>
        ...
        <li>Five-card hands (in order of lowest to highest value, so any full house will beat any regular flush)
          <ul>
            <li>
              Straight: Any 5 cards in a sequence (but not all of the same suit). Rank is determined by the value of the biggest card, with the suit used only as a tie-breaker.
            </li>
            <li>
